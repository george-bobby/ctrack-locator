...
function RoutingMachine({ startLocation, endLocation }: NavigationMapProps) {
  const map = useMap();
...
export default function NavigationMap({ startLocation, endLocation }: NavigationMapProps) {
  ...
  if (!startPoint || !endPoint) {
    return <div className="h-full w-full bg-muted flex items-center justify-center">Location data not found</div>;
  }
