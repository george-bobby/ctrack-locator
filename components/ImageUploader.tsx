  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: err instanceof Error ? err.message : "Failed to detect location. Please try a different image or try again later.",
        variant: "destructive"
      });
    } finally {
      setIsLoading(false);
        ...
        <Button 
          ...
          onClick={() => {
            toast({
              ...
              description: "Camera functionality will be available in the mobile app version.",
            });
          }}
        >
